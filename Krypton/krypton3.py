ct = "KSVVW BGSJD SVSIS VXBMN YQUUK BNWCU ANMJS"
...
count = collections.Counter(found3)
count.update(found2)
count.update(found1)

count.pop(' ') # obviously spaces don't count
print(count.most_common(26))
# use general letter frequency table
# https://en.wikipedia.org/wiki/Letter_frequency
table = 'ETASOINRDLUCMFYWGPBKHVQXZJ' # most common letters in English
table = 'EATSORNIHCLDUPMFWGYBKVXQJZ' # after some correction for readable text
dict = {}
for i, c in enumerate(count.most_common(26)):
    dict[c[0]] = table[i]
